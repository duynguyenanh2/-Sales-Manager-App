...
public class ChartBRFrm extends javax.swing.JFrame {

    int xMouse, yMouse;
    JTable table;

    public ChartBRFrm(JTable table) {
        initComponents();
        this.table = table;
        init();
    }
    ...
    private void showChart(JTable table) {
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            dcd.setValue((Long) table.getValueAt(i, 3), "Tổng tiền", (String) table.getValueAt(i, 1));
        }

        JFreeChart chart = ChartFactory.createBarChart("Doanh thu theo sản phẩm", "Sản phẩm", "Tổng tiền", dcd, PlotOrientation.VERTICAL, true, true, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChartBRFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
