...
public class ChartDTNgayFrm extends javax.swing.JFrame {

    int xMouse, yMouse;
    JTable table;

    public ChartDTNgayFrm(JTable table) {
        initComponents();
        this.table = table;
        init();
    }
    ...
    private void showChart(JTable table) {
        ...
        JFreeChart chart = ChartFactory.createLineChart("Doanh thu theo ngày", "Ngày", "Tổng tiền", dcd, PlotOrientation.VERTICAL, true, true, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChartDTNgayFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
