...
public class ChartDTThangFrm extends javax.swing.JFrame {

    int xMouse, yMouse;
    JTable table;

    public ChartDTThangFrm(JTable table) {
        initComponents();
        this.table = table;
        init();
    }
    ...
    private void showChart(JTable table) {
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            dcd.setValue((Long) table.getValueAt(i, 1), "Tổng tiền", (String) table.getValueAt(i, 0));
        }

        JFreeChart chart = ChartFactory.createLineChart("Doanh thu theo tháng", "Tháng", "Tổng tiền", dcd, PlotOrientation.VERTICAL, true, true, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChartDTThangFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
